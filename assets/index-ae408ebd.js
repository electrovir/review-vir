 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const dr=globalThis,kn=dr.trustedTypes,wo=kn?kn.createPolicy("lit-html",{createHTML:t=>t}):void 0,Hc="$lit$",Fe=`lit$${Math.random().toFixed(9).slice(2)}$`,Fc="?"+Fe,tp=`<${Fc}>`,ht=document,yr=()=>ht.createComment(""),br=t=>t===null||typeof t!="object"&&typeof t!="function",zc=Array.isArray,rp=t=>zc(t)||typeof(t==null?void 0:t[Symbol.iterator])=="function",Ss=`[ 	
\f\r]`,rr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,yo=/-->/g,bo=/>/g,et=RegExp(`>|${Ss}(?:([^\\s"'>=/]+)(${Ss}*=${Ss}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),vo=/'/g,$o=/"/g,Uc=/^(?:script|style|textarea|title)$/i,np=t=>(e,...r)=>({_$litType$:t,strings:e,values:r}),sp=np(1),fe=Symbol.for("lit-noChange"),N=Symbol.for("lit-nothing"),To=new WeakMap,ot=ht.createTreeWalker(ht,129);function jc(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return wo!==void 0?wo.createHTML(e):e}const ip=(t,e)=>{const r=t.length-1,n=[];let s,i=e===2?"<svg>":"",a=rr;for(let o=0;o<r;o++){const l=t[o];let u,c,d=-1,f=0;for(;f<l.length&&(a.lastIndex=f,c=a.exec(l),c!==null);)f=a.lastIndex,a===rr?c[1]==="!--"?a=yo:c[1]!==void 0?a=bo:c[2]!==void 0?(Uc.test(c[2])&&(s=RegExp("</"+c[2],"g")),a=et):c[3]!==void 0&&(a=et):a===et?c[0]===">"?(a=s??rr,d=-1):c[1]===void 0?d=-2:(d=a.lastIndex-c[2].length,u=c[1],a=c[3]===void 0?et:c[3]==='"'?$o:vo):a===$o||a===vo?a=et:a===yo||a===bo?a=rr:(a=et,s=void 0);const h=a===et&&t[o+1].startsWith("/>")?" ":"";i+=a===rr?l+tp:d>=0?(n.push(u),l.slice(0,d)+Hc+l.slice(d)+Fe+h):l+Fe+(d===-2?o:h)}return[jc(t,i+(t[r]||"<?>")+(e===2?"</svg>":"")),n]};class vr{constructor({strings:e,_$litType$:r},n){let s;this.parts=[];let i=0,a=0;const o=e.length-1,l=this.parts,[u,c]=ip(e,r);if(this.el=vr.createElement(u,n),ot.currentNode=this.el.content,r===2){const d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(s=ot.nextNode())!==null&&l.length<o;){if(s.nodeType===1){if(s.hasAttributes())for(const d of s.getAttributeNames())if(d.endsWith(Hc)){const f=c[a++],h=s.getAttribute(d).split(Fe),m=/([.?@])?(.*)/.exec(f);l.push({type:1,index:i,name:m[2],strings:h,ctor:m[1]==="."?op:m[1]==="?"?lp:m[1]==="@"?up:Jn}),s.removeAttribute(d)}else d.startsWith(Fe)&&(l.push({type:6,index:i}),s.removeAttribute(d));if(Uc.test(s.tagName)){const d=s.textContent.split(Fe),f=d.length-1;if(f>0){s.textContent=kn?kn.emptyScript:"";for(let h=0;h<f;h++)s.append(d[h],yr()),ot.nextNode(),l.push({type:2,index:++i});s.append(d[f],yr())}}}else if(s.nodeType===8)if(s.data===Fc)l.push({type:2,index:i});else{let d=-1;for(;(d=s.data.indexOf(Fe,d+1))!==-1;)l.push({type:7,index:i}),d+=Fe.length-1}i++}}static createElement(e,r){const n=ht.createElement("template");return n.innerHTML=e,n}}function zt(t,e,r=t,n){var a,o;if(e===fe)return e;let s=n!==void 0?(a=r._$Co)==null?void 0:a[n]:r._$Cl;const i=br(e)?void 0:e._$litDirective$;return(s==null?void 0:s.constructor)!==i&&((o=s==null?void 0:s._$AO)==null||o.call(s,!1),i===void 0?s=void 0:(s=new i(t),s._$AT(t,r,n)),n!==void 0?(r._$Co??(r._$Co=[]))[n]=s:r._$Cl=s),s!==void 0&&(e=zt(t,s._$AS(t,e.values),s,n)),e}class ap{constructor(e,r){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:r},parts:n}=this._$AD,s=((e==null?void 0:e.creationScope)??ht).importNode(r,!0);ot.currentNode=s;let i=ot.nextNode(),a=0,o=0,l=n[0];for(;l!==void 0;){if(a===l.index){let u;l.type===2?u=new Rr(i,i.nextSibling,this,e):l.type===1?u=new l.ctor(i,l.name,l.strings,this,e):l.type===6&&(u=new cp(i,this,e)),this._$AV.push(u),l=n[++o]}a!==(l==null?void 0:l.index)&&(i=ot.nextNode(),a++)}return ot.currentNode=ht,s}p(e){let r=0;for(const n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,r),r+=n.strings.length-2):n._$AI(e[r])),r++}}class Rr{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,r,n,s){this.type=2,this._$AH=N,this._$AN=void 0,this._$AA=e,this._$AB=r,this._$AM=n,this.options=s,this._$Cv=(s==null?void 0:s.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const r=this._$AM;return r!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=r.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,r=this){e=zt(this,e,r),br(e)?e===N||e==null||e===""?(this._$AH!==N&&this._$AR(),this._$AH=N):e!==this._$AH&&e!==fe&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):rp(e)?this.k(e):this._(e)}S(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.S(e))}_(e){this._$AH!==N&&br(this._$AH)?this._$AA.nextSibling.data=e:this.T(ht.createTextNode(e)),this._$AH=e}$(e){var i;const{values:r,_$litType$:n}=e,s=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=vr.createElement(jc(n.h,n.h[0]),this.options)),n);if(((i=this._$AH)==null?void 0:i._$AD)===s)this._$AH.p(r);else{const a=new ap(s,this),o=a.u(this.options);a.p(r),this.T(o),this._$AH=a}}_$AC(e){let r=To.get(e.strings);return r===void 0&&To.set(e.strings,r=new vr(e)),r}k(e){zc(this._$AH)||(this._$AH=[],this._$AR());const r=this._$AH;let n,s=0;for(const i of e)s===r.length?r.push(n=new Rr(this.S(yr()),this.S(yr()),this,this.options)):n=r[s],n._$AI(i),s++;s<r.length&&(this._$AR(n&&n._$AB.nextSibling,s),r.length=s)}_$AR(e=this._$AA.nextSibling,r){var n;for((n=this._$AP)==null?void 0:n.call(this,!1,!0,r);e&&e!==this._$AB;){const s=e.nextSibling;e.remove(),e=s}}setConnected(e){var r;this._$AM===void 0&&(this._$Cv=e,(r=this._$AP)==null||r.call(this,e))}}class Jn{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,r,n,s,i){this.type=1,this._$AH=N,this._$AN=void 0,this.element=e,this.name=r,this._$AM=s,this.options=i,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=N}_$AI(e,r=this,n,s){const i=this.strings;let a=!1;if(i===void 0)e=zt(this,e,r,0),a=!br(e)||e!==this._$AH&&e!==fe,a&&(this._$AH=e);else{const o=e;let l,u;for(e=i[0],l=0;l<i.length-1;l++)u=zt(this,o[n+l],r,l),u===fe&&(u=this._$AH[l]),a||(a=!br(u)||u!==this._$AH[l]),u===N?e=N:e!==N&&(e+=(u??"")+i[l+1]),this._$AH[l]=u}a&&!s&&this.j(e)}j(e){e===N?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class op extends Jn{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===N?void 0:e}}class lp extends Jn{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==N)}}class up extends Jn{constructor(e,r,n,s,i){super(e,r,n,s,i),this.type=5}_$AI(e,r=this){if((e=zt(this,e,r,0)??N)===fe)return;const n=this._$AH,s=e===N&&n!==N||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==N&&(n===N||s);s&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var r;typeof this._$AH=="function"?this._$AH.call(((r=this.options)==null?void 0:r.host)??this.element,e):this._$AH.handleEvent(e)}}class cp{constructor(e,r,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=r,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){zt(this,e)}}const Ms=dr.litHtmlPolyfillSupport;Ms==null||Ms(vr,Rr),(dr.litHtmlVersions??(dr.litHtmlVersions=[])).push("3.1.3");const dp=(t,e,r)=>{const n=(r==null?void 0:r.renderBefore)??e;let s=n._$litPart$;if(s===void 0){const i=(r==null?void 0:r.renderBefore)??null;n._$litPart$=s=new Rr(e.insertBefore(yr(),i),i,void 0,r??{})}return s._$AI(t),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,Te=bt({"vira-extended-animation-duration":"1.2s","vira-pretty-animation-duration":"300ms","vira-interaction-animation-duration":"84ms"}),mt=bt({"vira-focus-outline-color":"#59b1ff","vira-focus-outline-border-radius":A`calc(${$e["vira-form-input-radius"].value} + 4px)`});function oa({selector:t,elementBorderSize:e,outlineGap:r=2,outlineWidth:n=2}){const s=ee(cg(n+r+e));return A`
    ...
    `}const Ue=bt({"vira-form-border-color":"#cccccc","vira-form-background-color":"white","vira-form-foreground-color":"black","vira-form-focus-color":mt["vira-focus-outline-color"].value,"vira-form-selection-hover-background-color":"#d2eaff","vira-form-selection-hover-foreground-color":"black"}),Ln=A`
    padding: 0;
    margin: 0;
`,xe=A`
    ${Ln};
...
`,C=Ne()({tagName:"vira-icon",hostClasses:{"vira-icon-fit-container":({inputs:t})=>!!t.fitContainer},styles:({hostClasses:t})=>A`
    ...
    `,renderCallback({inputs:t}){return w`
        ...
        :host {
            ...
            background-color: ${Ue["vira-form-background-color"].value};
            border: 1px solid ${Ue["vira-form-border-color"].value};
            color: ${Ue["vira-form-foreground-color"].value};
            ${Bd.menuShadow}
        }
        ...
        ${mi.css.selected(".dropdown-item:not(.disabled)")} {
            background-color: ${Ue["vira-form-selection-hover-background-color"].value};
            outline: none;
        }
    ...
    `,stateInitStatic:{loadedUrls:{},erroredUrls:{}},renderCallback({inputs:t,state:e,updateState:r,dispatch:n,events:s}){const i=t.imageUrl,a=e.erroredUrls[i]?w`
        ...
        `,stateInitStatic:{forcedInputWidth:0,showPassword:!1},renderCallback:({inputs:t,dispatch:e,state:r,updateState:n,events:s})=>{const{filtered:i}=cf({value:t.value??"",allowed:t.allowedInputs,blocked:t.blockedInputs}),a=t.icon?w`
            ...
            <label>
                ...
                />
                ${ze(!!(t.showClearButton&&t.value),w`
                        <button
