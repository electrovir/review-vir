...
`;var U=(e=>(e.OpenPullRequests="open-pull-requests",e.ClosedPullRequests="closed-pull-requests",e))(U||{});function st(e){if(!e.filter.onlyMyself&&!e.filter.org)throw new Error("Github query too broad: must filter to self or an org")}const at={"open-pull-requests"(e){var r,s;return["is:open","type:pr","archived:false",((r=e.filter)==null?void 0:r.onlyMyself)&&"involves:@me",((s=e.filter)==null?void 0:s.org)&&`org:${e.filter.org}`].filter(P).join(" ")},"closed-pull-requests"(e){var a,o;const t=k(te(),{weeks:-1});return["is:closed","type:pr","archived:false",`closed:>=${Ze(t,{includeSeconds:!1}).date}`,((a=e.filter)==null?void 0:a.onlyMyself)&&"involves:@me",((o=e.filter)==null?void 0:o.org)&&`org:${e.filter.org}`].filter(P).join(" ")}};function nt(e,t,r,s){return st(r),{query:ot[e],variables:{searchQuery:at[t](r),afterCursor:s||null}}}var D=(e=>(e.PullRequest="pull-request",e))(D||{});const ot={"pull-request":rt},it=ve({"pull-request":tt},(e,t)=>m(Se(t,{authTokenName:""}),!0)),ut={"pull-request"(e){return{totalItemCount:e.data.search.issueCount,nextPageCursor:e.data.search.pageInfo.hasNextPage&&e.data.search.pageInfo.endCursor||void 0}}},lt={"pull-request"(e){const t=e.slice(-1)[0];return{authTokenName:t.authTokenName,errors:e.flatMap(r=>r.errors??[]),data:{rateLimit:{...t.data.rateLimit,cost:e.map(r=>r.data.rateLimit.cost).reduce(K),nodeCount:e.map(r=>r.data.rateLimit.nodeCount).reduce(K)},viewer:t.data.viewer,search:{issueCount:t.data.search.issueCount,pageInfo:t.data.search.pageInfo,nodes:e.flatMap(r=>r.data.search.nodes)}}}}};async function z(e,t,r,s){try{let a;const o=[];do{const n=nt(e,t,r,a),u=await(await fetch("https://api.github.com/graphql",{method:"post",headers:{"Content-Type":"application/json",Accept:"application/json",Authorization:`bearer ${s.authTokenSecret}`},body:JSON.stringify(n)})).json();u.authTokenName=s.authTokenName,u.errors&&u.errors.forEach(h=>{A(h,re)});try{A(u,it[e])}catch(h){throw console.info(u),h}const E=ut[e](u);if(a=E.nextPageCursor,o.push(u),E.totalItemCount>1e3)throw new Error(`Search too broad: got '${E.totalItemCount}' items.`)}while(a);if(!J(o,1))throw new Error("No data received from GitHub.");return lt[e](o)}catch(a){const o=Re(a,`Failed to fetch data for token '${s.authTokenName}'.`);return console.error(o),o}}function dt(e,t,r,s){var h,w,M,q,O,F,L,V,j,Q;const a={closed:t.closedAt?C(t.closedAt):void 0,created:C(t.createdAt),lastUpdated:C(t.updatedAt)},o=t.assignees.nodes.map(c),n=[c(t.author)],i={assignees:ae(o.length?o:n),reviewers:mt(t)},u=t.mergedAt?v.Merged:t.closedAt?v.Rejected:t.isDraft?v.Draft:v.Open;return{auth:{client:Ee.Github,tokenName:e},branches:{headBranch:{branchName:((h=t.headRef)==null?void 0:h.name)||new Error("Missing 'Contents' read permissions."),headCommitHash:((M=(w=t.headRef)==null?void 0:w.target)==null?void 0:M.oid)||new Error("Missing 'Contents' read permissions."),repo:{isArchived:t.headRepository.isArchived,isPrivate:t.headRepository.isPrivate,htmlUrl:t.headRepository.url,repoName:t.headRepository.name,repoOwner:c(t.headRepository.owner)}},targetBranch:{branchName:((q=t.baseRef)==null?void 0:q.name)||new Error("Missing 'Contents' read permissions."),headCommitHash:((F=(O=t.baseRef)==null?void 0:O.target)==null?void 0:F.oid)||new Error("Missing 'Contents' read permissions."),repo:{isArchived:t.baseRepository.isArchived,isPrivate:t.baseRepository.isPrivate,htmlUrl:t.baseRepository.url,repoName:t.baseRepository.name,repoOwner:c(t.baseRepository.owner)}}},changes:{additions:t.additions,deletions:t.deletions,changedFiles:t.changedFiles},dates:a,id:{htmlUrl:t.url,prId:t.id,prNumber:String(t.number),title:t.title,owner:c(t.baseRepository.owner)},status:{checksStatus:ht((Q=(j=(V=(L=t.commits.nodes[0])==null?void 0:L.commit)==null?void 0:V.statusCheckRollup)==null?void 0:j.contexts)==null?void 0:Q.checkRunCountsByState),comments:ct(t.reviewThreads.nodes),commitCount:t.commits.totalCount,mergeStatus:u,mergedBy:t.mergedBy?c(t.mergedBy):void 0,needsReviewFromCurrentUser:ft(u,r,i),hasMergeConflicts:t.mergeable===N.Conflicting,labels:t.labels?t.labels.nodes.map(x=>({...x,color:`#${x.color}`})):[]},users:i,cost:s}}function ct(e){return e.reduce((t,r)=>(r.isResolved&&t.resolved++,t.total++,t),{resolved:0,total:0})}function ft(e,t,r){return e===v.Open&&(t.username in r.reviewers.pending||!(t.username in r.reviewers.submitted))&&!(t.username in r.assignees)}function mt(e){const t=ae(e.reviewRequests.nodes.map(a=>c(a.requestedReviewer))),r=ye([...e.latestReviews.nodes,...e.latestOpinionatedReviews.nodes],a=>{const o=c(a.author),n=a.state===R.Approved?B.Accepted:a.state===R.ChangesRequested?B.Rejected:void 0;if(n)return{user:o,reviewStatus:n};t[o.username]=o},P),s=_(r,a=>a.user.username);return{pending:Ve(t,a=>!(a in s)),submitted:s}}function ht(e){return e?e.reduce((r,s)=>(T(Ye,s.state)?r.failCount+=s.count:T(ke,s.state)?r.inProgressCount+=s.count:T(Ge,s.state)&&(r.successCount+=s.count),r.totalCount++,r),{successCount:0,failCount:0,inProgressCount:0,totalCount:0}):new Error("Missing 'Contents' or 'Commit statuses' read permissions.")}function c(e){return{avatarUrl:e.teamAvatarUrl||e.avatarUrl||"",profileUrl:e.url,username:e.login}}function ae(e){return _(e,t=>t.username)}let H=!1;async function pt(e){if(H)throw new Error("Refusing to fetch because GraphQL query cost is too high.");const t=await Promise.allSettled(e.flatMap(n=>[z(D.PullRequest,U.OpenPullRequests,{filter:{onlyMyself:!0}},n),z(D.PullRequest,U.ClosedPullRequests,{filter:{onlyMyself:!0}},n)]));let r;const s=t.flatMap(n=>{if(n.status==="fulfilled"){const i=n.value;if(Ce(i))return[i];if(i.data.rateLimit.cost>1)throw H=!0,new Error("GraphQL query cost is too high.");return r||(r=c(i.data.viewer)),i.data.search.nodes.map(u=>(Le(r),dt(i.authTokenName,u,r,i.data.rateLimit)))}else return[X(n.reason)]}),a=Te(s.map(n=>n instanceof Error?[Ae(32),n]:[n.id.prId,n])),o=Object.values(a).sort((n,i)=>{if(n instanceof Error&&i instanceof Error){const u=n.name.localeCompare(i.name);return u||n.message.localeCompare(i.message)}else return n instanceof Error?-1:i instanceof Error||Y({fullDate:n.dates.created,relativeTo:i.dates.created})?1:-1});if(!r)throw new Error("User was never parsed from the GitHub GraphQL response.");return console.log(o.filter(n=>n.id.prNumber==="619")[0]),{pullRequests:o,user:r}}const gt={updateInterval:{seconds:10},cacheTimeout:{minutes:5}},vt=m({timestamp:0,data:_e},!0),f=class f extends Xe{constructor(r,s){super();p(this,"value");p(this,"lastResolvedValue");p(this,"options",gt);this.authTokens=r,s&&this.overrideOptions(s),this.setPromiseValue(this.loadCachedValue()),this.scheduleFutureUpdate()}async saveCache(r){await f.cacheStore.setItem(f.cacheKey,{timestamp:Date.now(),data:r})}async loadCachedValue(){const r=await f.cacheStore.getItem(f.cacheKey);return Pe(r,vt)?(Y({fullDate:te(),relativeTo:k(C(r.timestamp),this.options.cacheTimeout)})?this.setUpdatedValue(!0):setTimeout(()=>this.setUpdatedValue(!0)),r.data):this.fetchData()}setPromiseValue(r){this.dispatch(new Ue({detail:r})),this.value=r,r.then(s=>{this.dispatch(new De({detail:s})),this.value=s,Ie(this.lastResolvedValue,s)||(this.dispatch(new be({detail:s})),this.lastResolvedValue=s,this.saveCache(s))}).catch(s=>{this.dispatch(new Ne({detail:X(s)}))})}overrideOptions(r){r&&(this.options=G(this.options,r))}async fetchData(){return await pt(this.authTokens)}scheduleFutureUpdate(){globalThis.setTimeout(()=>{this.setUpdatedValue(!1)},we(this.options.updateInterval,Me.Milliseconds).milliseconds)}async setUpdatedValue(r){if(this.scheduleFutureUpdate(),!r&&qe(this.value))return this.value;const s=this.fetchData();return this.setPromiseValue(s),await s}};p(f,"cacheStore",Fe.createInstance({description:"github client cache for review-vir",name:"review-vir-github-cache",storeName:"review-vir-github-cache"})),p(f,"cacheKey","value");let I=f;const yt=Oe({init(e){return new I(e)}});export{I as GithubClient,yt as githubClient};
